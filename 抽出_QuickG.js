function searchDataGQ2023() {
  ...
  for (var r = 0; r < matchingRows1.length; r++) {
    ...
    for (var h = 0; h < headersB.length; h++) {
      if (h < 8) { // H列まで
        // Gデータ(QUICK)の5行目のJ列までとG（日経＋QUICK合計）3行目の項目名を比較
        ...
        // Gデータ(QUICK)の5行目のJ列以降とG（日経＋QUICK合計）2行目の項目名を比較
  ...
  for (var r = 0; r < matchingRows2.length; r++) {
    ...
    for (var h = 0; h < headersB.length; h++) {
      if (h < 8) { // H列まで
        // Gデータ(QUICK)の5行目のJ列までと入力シート（合計QUICKG）3行目の項目名を比較
        ...
        // Gデータ(QUICK)の5行目のJ列以降と入力シート（合計QUICKG）2行目の項目名を比較
